/**
 * Structured, level-gated logger for the landing page.
 *
 * Usage:
 *   import { createLogger } from '~/utils/logger';
 *   const log = createLogger('HeroSection');
 *   log.info('Section loaded', { variant: 'A' });
 *   log.error('Failed to submit form', { error: err.message });
 *
