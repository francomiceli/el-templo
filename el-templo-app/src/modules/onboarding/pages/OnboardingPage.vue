...
// If the user has a known birth date on file (imported members), derive the
// age bucket up-front and skip Q1 entirely.
...
// When Q1 (age) is skipped because we know the DOB, the quiz drops by 1.
