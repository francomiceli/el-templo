...
- [x] **DEPLOY-01**: GitHub Actions workflow builds, deploys, and restarts el-templo-bot alongside el-templo-api
- [x] **DEPLOY-02**: PM2 ecosystem file configured for bot process in production
