...
- [ ] 148-01-PLAN.md — Fundación backend: columna createdMemberId (mig 0162) + AssignPlanInput recorder fields + createMinimalMember [wave 1]
- [ ] 148-02-PLAN.md — Endpoint POST /alta atómico e idempotente (resolver/crear alumno + assignPlan + cobro pendiente, branch-gated) [wave 2]
- [ ] 148-03-PLAN.md — Cascade en void (alumno-nuevo → membresía cancelada + alumno inactivo) + surface createdMember [wave 2]
