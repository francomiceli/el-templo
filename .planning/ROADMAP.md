...
- [ ] 140-01-PLAN.md — Backend foundation: migration 0156 idempotency_key, FINANCE_LOAD_ROLES, recorderRole+idempotencyKey threading through renewSubscription, cobro-suelto plumbing
...
| 140. Carga única + cobro suelto + rol profe | 0/3            | Planned     | -          |
