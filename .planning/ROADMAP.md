...
- [ ] 154-04-PLAN.md — Frontend: CobrosPage ?memberId= + gates de UI (CobrosPage/AssignPlanDialog/PlanFormDialog) (ALUM-02, ALUM-03)
...
| 154. Alumnos (de-Templo-ficación + accesos)     | 3/5            | In Progress |            |
