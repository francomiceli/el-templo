...
- [ ] 149-01-PLAN.md — API: sets RBAC core+overrides Templo + guards de escritura dueño-only en plans/promo-plans (D-11)
- [ ] 149-02-PLAN.md — API: eliminar la perilla de Configuración de Caja (endpoints/servicio/schemas) + umbral hardcodeado OVERDUE_DAYS (D-13)
