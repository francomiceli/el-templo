...
## Current Milestone: v5.8 Sesiones de Prueba — automatización y self-service
...
See: .planning/REQUIREMENTS.md (v5.8 scope — Sesiones de Prueba: automatización y self-service)
