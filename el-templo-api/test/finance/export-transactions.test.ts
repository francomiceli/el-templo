 ...
 * `members` en TENANT_STRICT_MODULES una lectura de `users` sin estampa hace
...
async function seedFixtures(app: FastifyInstance): Promise<SeededContext> {
  ...
  // ES branch here is a country-scope vehicle; its cash payloads use 'ARS'
  // (see E4/postTransaction). Seed its efectivo caja as ARS to match.
