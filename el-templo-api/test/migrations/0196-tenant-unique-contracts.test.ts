...
describe("Verificador de uniques e índices por tenant — gate fail-closed (CON-02, D-14)", () => {
  ...
  it("Test 10: el reporte cierra en 0 discrepancias y cubre las 95 tablas gym-owned", () => {
    ...
    expect(
      ...
      `El verificador solo pudo mirar ${report.gymOwnedChecked} de las 95 tablas gym-owned ` +
        `(87 de la fase 167 + session_week_regime de la 159 + 3 de partners de la 179 ` +
        `+ 3 de comunicaciones de la 193 + staff_shifts de la 0223): ` +
