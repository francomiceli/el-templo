...
INSERT INTO exercises (pattern, category, category_secondary, exercise, exercise_2, position, effort, exercise_level, code_number, difficulty, dificultad_lineal, route)
VALUES
