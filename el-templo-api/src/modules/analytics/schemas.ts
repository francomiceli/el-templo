...
const errorSchema = {
  ...
  properties: {
    ...
    // `enforceBranchScope` (rol `admin_sede`) traen `code` — sin esta propiedad
        ...
        attentionList: {
          ...
          items: {
            ...
            properties: {
              ...
              segment: {
                type: ["string", "null"],
                enum: ["optima", "regular", "alerta", "ausente", null],
              },
            },
          },
        },
        ...
        nominalList: {
          ...
          items: {
            ...
            properties: {
              ...
              phone: { type: ["string", "null"] },
              segment: { type: "string", enum: ["alerta", "ausente"] },
            },
          },
        },
      },
